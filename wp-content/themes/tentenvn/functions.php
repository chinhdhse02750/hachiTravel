...
function load_admin_style() {
  ...
  wp_register_style( 'flatpick_css', get_template_directory_uri() . '/css/flatpickr.min.css', false, '1.0.0' );
  wp_enqueue_style('admin_css');
  wp_enqueue_style('flatpick_css');
}
add_action( 'admin_enqueue_scripts', 'load_admin_style' );

function load_admin_js() {
  wp_register_script( 'admin_js', get_template_directory_uri() . '/js/admin.js', false, '1.0.0' );
wp_register_script( 'flatpick_js', get_template_directory_uri() . '/js/flatpickr.min.js', false, '1.0.0' );
  wp_enqueue_script('admin_js');
   wp_enqueue_script('flatpick_js');
}
