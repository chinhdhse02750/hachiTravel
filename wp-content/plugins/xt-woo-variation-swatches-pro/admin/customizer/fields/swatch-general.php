...
if ($this->core->access_manager()->can_use_premium_code__premium_only()) {
    ...
    if ($type === 'archives') {
        ...
        $fields[] = array(
            'id' => $type . '_show_quantity_field',
            'section' => $type . '-swatch-general',
            'label' => esc_html__('Show Quantity Field', 'xt-woo-variation-swatches'),
            'type' => 'radio-buttonset',
            'choices' => array(
                '0' => esc_attr__('No', 'xt-woo-variation-swatches'),
                '1' => esc_attr__('Yes', 'xt-woo-variation-swatches'),
        ...
        $fields[] = array(
            'id' => $type . '_quantity_field_display',
            'section' => $type . '-swatch-general',
            'label' => esc_html__('Quantity Field Display', 'xt-woo-variation-swatches'),
            'type' => 'radio-buttonset',
            'choices' => array(
                'block' => esc_attr__('Block', 'xt-woo-variation-swatches'),
                'inline' => esc_attr__('Inline', 'xt-woo-variation-swatches'),
            ),
            'default' => 'block',
            'transport' => 'postMessage',
            'js_vars' => array(
                array(
                    'element' => $element_prefix . ' .xt_woovs-quantity-wrap',
                    'function' => 'class',
                    'prefix' => 'xt_woovs-quantity-wrap-'
                )
            ),
            'active_callback' => array(
                array(
                    'setting' => $type . '_show_quantity_field',
                    'operator' => '==',
                    'value' => '1',
                ),
            ),
